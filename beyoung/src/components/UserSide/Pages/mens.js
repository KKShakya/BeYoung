...
function Mens() {
  ...
  //   let change = await getData("mens", page, "strike_price", order)
...
<Box ml={'20%'}>
      <Center fontSize={'1.3rem'} fontFamily='garamond' fontWeight={'bold'}>Designer Clothing For Men</Center>
      <Center color="gray.600" fontSize="1.2rem">
        Shop designer clothing for men with price comparison across 500+ stores
        in one place. Discover the latest designer clothing for men at
        BeYoung.
      </Center>
      </Box>
